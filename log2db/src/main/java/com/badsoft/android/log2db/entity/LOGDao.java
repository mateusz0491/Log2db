...
public class LOGDao extends AbstractDao<LOG, Long> {
    ...
    public static class Properties {
        ...
        public final static Property PREETYDATE = new Property(3, String.class, "PREETYDATE", false, "PREETYDATE");
        public final static Property MESSAGE = new Property(4, String.class, "MESSAGE", false, "MESSAGE");
        public final static Property STACKTRACE = new Property(5, String.class, "STACKTRACE", false, "STACKTRACE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LOG\" (" + //
                ...
                "\"PREETYDATE\" TEXT," + // 3: PREETYDATE
                "\"MESSAGE\" TEXT," + // 4: MESSAGE
                "\"STACKTRACE\" TEXT," + // 5: STACKTRACE
                "\"TYPE\" TEXT);"); // 6: TYPE
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, LOG entity) {
        ...
        String PREETYDATE = entity.getPREETYDATE();
        if (PREETYDATE != null) {
            stmt.bindString(4, PREETYDATE);
        }
    ...
    public LOG readEntity(Cursor cursor, int offset) {
        LOG entity = new LOG( //
            ...
            new java.util.Date(cursor.getLong(offset + 2)), // CREATEDATE
                cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // PREETYDATE
                cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // MESSAGE
                cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // STACKTRACE
    ...
    public void readEntity(Cursor cursor, LOG entity, int offset) {
        ...
        entity.setPREETYDATE(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setMESSAGE(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setSTACKTRACE(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
